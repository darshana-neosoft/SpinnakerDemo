...
mysqli_close($conn);
header ("Location: lastfullmonth.php");
exit;
}
...
<div id="modaladd" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="score_form" name="score_form" action="lastfullmonth.php" method="POST">
...
<div class="row row-screen">
	...
	<div class="row row-screen whiteboard" id="navigation">
		<div class="">
			<div class="pull-right date-time dropdown"><a  href="" class="  dropdown-toggle" id="menu1" data-toggle="dropdown"> Last Full Month <i class="fa fa-caret-down" aria-hidden="true" ></i></a>
			...
			<ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
		     ...
		     <h3 style="margin-top:0px;"><small>Apr 1, 2017 - Apr 30, 2017</small></h3>
			</div>
		</div>
	</div>
	<br>
	<div class="row row-screen">
		...
		<div class="table-inner1">
			<table class="table marB15">
				<thead>
					<tr>
						<th class="text-center">Last Full Month</th>
				...
				<tbody>
					...
					<tr>
						...
						<div class="gross-year padT10"># of Cases Quoted</div><button class="btn ">583</button>
						
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">560<i class="fa fa-arrow-up" aria-hidden="true"></i><span>4%</span></button>
							</div>

						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">525 <i class="fa fa-arrow-up" aria-hidden="true"></i><span>11%</span></button>
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="gross-year padT10">Face Amount of Cases Quoted ($M)</div><button class="btn ">$323</button>
						
						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">$301<i class="fa fa-arrow-up" aria-hidden="true"></i><span>7%</span></button>
							</div>
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">$256<i class="fa fa-arrow-up" aria-hidden="true"></i><span>26%</span></button>
							</div>
						</td>
					</tr>
		...
		<div class="table-inner">
			<table class="table marB15" border="1">
				...
				<tbody>
					...
					<td class="text-center">	$1,45,32,656	</td>
					...
					<tr>
					<td >	Willis / HRH	</td>
					<td class="text-center">	$1,21,10,547	</td>
					...
					<td class="text-center">	$1,06,57,281	</td>
					...
					<td class="text-center">	$92,04,016	</td>
					...
					<td class="text-center">	$84,77,383	</td>
					...
					<tr>
					<td >	Coresource	</td>
					<td class="text-center">	$77,50,750	</td>
					...
					<td class="text-center">	$72,66,328	</td>
					...
					<td class="text-center">	$71,04,854	</td>
		...
		<div class="table-inner">
			<table class=" table marB15" border="1">
				...
				<tbody>
					...
					<tr>
					<td >	AR	</td>
					<td class="text-center">	$1,84,08,031	</td>
					<td class="text-center">	6%	</td>
					...
					<tr>
					<td >	NY	</td>
					<td class="text-center">	$1,69,54,766	</td>
					...
					<tr>
					<td >	IN	</td>
					<td class="text-center">	$1,55,01,500	</td>
					<td class="text-center">	5%	</td>
					...
					<tr>
					<td >	MI	</td>
					<td class="text-center">	$1,42,09,708	</td>
		...
		<div class="table-inner">
			<table class=" table marB15" border="1">
				...
				<tbody>
					<tr>
					<td >	Manufacturing	</td>
					<td class="text-center">	$4,06,91,438	</td>
					<td class="text-center">	13%	</td>
					...
					<tr>
					<td >	Construction	</td>
					<td class="text-center">	$3,39,09,531	</td>
					...
					<td class="text-center">	$2,98,40,388	</td>
					<td class="text-center">	9%	</td>
					...
					<td class="text-center">	$2,71,27,625	</td>
					<td class="text-center">	8%	</td>
					...
					<td class="text-center">	$2,57,71,244	</td>
					<td class="text-center">	8%	</td>
					...
					<td class="text-center">	$2,37,36,672	</td>
					<td class="text-center">	7%	</td>
					...
					<td class="text-center">	$2,17,02,100	</td>
					<td class="text-center">	7%	</td>
					...
					<td class="text-center">	$2,03,45,719	</td>
					<td class="text-center">	6%	</td>
					...
					<tr>
					<td >	Retail	</td>
					<td class="text-center">	$2,00,22,771	</td>
					<td class="text-center">	6%	</td>
...
<script type="text/javascript" src="js/lastfullmonth.js"></script>
