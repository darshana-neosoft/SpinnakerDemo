	...
	<div class="row row-screen whiteboard" id="navigation">
		<div class="">
		    ...
		    <li role="presentation"><a role="menuitem" tabindex="-1" href="year-date.php#sales-track">Year To Date View</a></li>
		      ...
		      <h3 style="margin-top:0px;"><small>Jan 1, 2017 - March 31, 2017</small></h3>
			</div>
		</div>
	</div>
	<br>
			...
			<table class="table marB15">
				...
				<tbody>
					...
					<tr>
						...
						<div class="gross-year padT10">Face Amount of Cases Quoted ($M)</div><button class="btn ">$969</button>
