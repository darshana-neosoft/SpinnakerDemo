	...
	<div class="row">
		...
		<div class="right-screen">
		 ...
		 <div class="row row-screen">
				<h1><span class="pull-right">Admin Panel</span><br></h1>
				<h4><span class="pull-right dashbord-title">Powered By Spinnaker Analytics</span></h4>
		 ...
		 <div class="row row-screen">
			...
			<h4 class="title-income date2"><div id="date"></div></h4>
		</div>
			<hr class="hr-line"/>
		</div>
...
<div id="modaladd" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="score_form" name="score_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
...
<input type = "submit" class = "btn btn-success select-option" value="Submit" name="submit">
<input type="button" class="btn btn-info select-option" data-dismiss="modal" value="Close"></input>
</div>
...
<div class="row row-screen">
		<div class="clearfix date-track">
			...
			<h4 class="title-income date2">As On Aug 15, 2017</h4>
		</div>
			<hr class="hr-line"/>
		</div>
	...
	<div class="row row-screen whiteboard" id="navigation">
		<div class="" >
			...
			<ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
		      <li role="presentation"><a role="menuitem" tabindex="-1" href="month-date.html#sales-track">Month To Date</a></li>
		      <li role="presentation"><a role="menuitem" tabindex="-1" href="quarterdate.html#sales-track">Quarter To Date</a></li>
		      <li role="presentation"><a role="menuitem" tabindex="-1" href="lastfullmonth.html#sales-track">Last Full Month</a></li>
		   
		      <li role="presentation"><a role="menuitem" tabindex="-1" href="lastfullquarter.html#sales-track">Last Full Quarter
			</a></li>
		    </ul>
		    <h3 style="margin-top:0px;"><small>Jan 1, 2017 - Aug 15, 2017</small></h3>
			</div>
		</div>
	</div>
	<br>
	<div class="row row-screen">
		...
		<div class="table-inner1">
			...
			<div class="foo blue"></div>bbbbbbbbbbbbbbbbbbbbbbb<br>
			<div class="foo darkblue"></div>bbbbbbbbbbbbbbbbbbbbbbb
			...
			<table class="table marB15" border="1">
				<thead>
					<tr>
						...
						<th >Broker</th>
						<th class="text-center">Quote FA ($M)</th>
...
<div class="row row-screen">
	...
	<div class="row row-screen">
	<h3 class="text-center" style="font-weight: bold;">This Page Has Been Disabled</h3>
</div>
</div>
...
document.getElementById("date").innerHTML = text+today;
});
