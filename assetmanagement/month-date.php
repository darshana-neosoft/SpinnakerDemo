...
mysqli_close($conn);
header ("Location: month-date.php");
exit;
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
			...
			<button type="button" class="btn btn-grey">Contact Channel Partner</button>	
			</div>
		</div>
...
<div id="modaladd" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="score_form" name="score_form" action="month-date.php" method="POST">
...
<div class="row row-screen">
	...
	<div class="row row-screen whiteboard" id="navigation">
		<div class="">
			<div class="pull-right date-time dropdown"><a  href="" class="  dropdown-toggle" id="menu1" data-toggle="dropdown">Month To Date <i class="fa fa-caret-down" aria-hidden="true" ></i></a>
		    ...
		    <h3 style="margin-top:0px;"><small>Dec 1, 2017 - Dec 6, 2017</small></h3>
			</div>
		</div>
	</div>
	<br>
			...
			<table class="table marB15">
				...
				<tbody>
					...
					<tr>
						...
						<div class="gross-year padT10"># of Cases Quoted</div><button class="btn ">265</button>
						
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">245<i class="fa fa-arrow-up" aria-hidden="true"></i><span>8%</span></button>
							</div>

						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">239 <i class="fa fa-arrow-up" aria-hidden="true"></i><span>11%</span></button>
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="gross-year padT10">AUM of Cases Quoted ($M)</div><button class="btn ">$147</button>
						
						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">$132<i class="fa fa-arrow-up" aria-hidden="true"></i><span>11%</span></button>
							</div>
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">$116<i class="fa fa-arrow-up" aria-hidden="true"></i><span>26%</span></button>
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">41%<i class="fa fa-arrow-up" aria-hidden="true"></i><span>5%</span></button>
							</div>
						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">40%<i class="fa fa-arrow-up" aria-hidden="true"></i><span>7%</span></button>
							</div>
						</td>
					</tr>
		...
		<div class="table-inner">
			<table class="table marB15" border="1">
				...
				<tbody>
					...
					<td class="text-center">	$66,05,753	</td>
					...
					<tr>
					<td >	Willis / HRH	</td>
					<td class="text-center">	$55,04,794	</td>
					...
					<td class="text-center">	$48,44,219	</td>
					...
					<td class="text-center">	$44,03,835	</td>
					...
					<td class="text-center">	$41,83,643	</td>
					...
					<td class="text-center">	$38,53,356	</td>
					...
					<tr>
					<td >	Coresource	</td>
					<td class="text-center">	$35,23,068	</td>
					...
					<td class="text-center">	$33,02,876	</td>
					...
					<td class="text-center">	$32,29,479	</td>
	...
	<h3 class="text-center title-dg">Cases By Geography</h3>
		...
		<div class="table-inner">
			<table class=" table marB15" border="1">
				...
				<tr>
					<td >	MA	</td>
					<td class="text-center">	$1,32,11,506	</td>
				...
				<tr>
					...
					<td >	CA	</td>
					<td class="text-center">	$1,10,09,588	</td>
					<td class="text-center">	8%	</td>
					<td class="text-center">	43	</td>
				...
				<tr>
					...
					<td >	PA	</td>
					<td class="text-center">	$96,88,438	</td>
					<td class="text-center">	7%	</td>
				...
				<tr>
					...
					<td >	TX	</td>
					<td class="text-center">	$88,07,670	</td>
					<td class="text-center">	6%	</td>
				...
				<tr>
					...
					<td >	AR	</td>
					<td class="text-center">	$83,67,287	</td>
					<td class="text-center">	6%	</td>
				...
				<tr>
					...
					<td >	NY	</td>
					<td class="text-center">	$77,06,712	</td>
				...
				<tr>
					...
					<td >	IN	</td>
					<td class="text-center">	$70,46,136	</td>
					<td class="text-center">	5%	</td>
				...
				<tr>
					...
					<td >	MI	</td>
					<td class="text-center">	$64,58,958	</td>
		...
		<div class="table-inner">
			<table class=" table marB15" border="1">
				...
				<tbody>
					<tr>
					<td >	Manufacturing	</td>
					<td class="text-center">	$1,84,96,108	</td>
					<td class="text-center">	13%	</td>
					...
					<tr>
					<td >	Construction	</td>
					<td class="text-center">	$1,54,13,423	</td>
					<td class="text-center">	11%	</td>
					...
					<td class="text-center">	$1,35,63,813	</td>
					<td class="text-center">	9%	</td>
					...
					<td class="text-center">	$1,23,30,739	</td>
					<td class="text-center">	8%	</td>
					<td class="text-center">	48	</td>
					...
					<td class="text-center">	$1,17,14,202	</td>
					<td class="text-center">	8%	</td>
					<td class="text-center">	45	</td>
					<td class="text-center">	21	</td>
					<td class="text-center">	47%	</td>
					...
					<td class="text-center">	$1,07,89,396	</td>
					<td class="text-center">	7%	</td>
					<td class="text-center">	42	</td>
					<td class="text-center">	19	</td>
					<td class="text-center">	45%	</td>
					...
					<td class="text-center">	$98,64,591	</td>
					<td class="text-center">	7%	</td>
					<td class="text-center">	38	</td>
					...
					<td class="text-center">	$92,48,054	</td>
					<td class="text-center">	6%	</td>
					...
					<tr>
					<td >	Retail	</td>
					<td class="text-center">	$91,01,259	</td>
					<td class="text-center">	6%	</td>
...
<input type = "reset" id="reset-button" onclick="reset_div()" class = "btn btn-grey select-option" value="Reset"></input>
...
<script type="text/javascript" src="js/monthdate.js"></script>
