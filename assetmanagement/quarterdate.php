...
mysqli_close($conn);
header ("Location: quarterdate.php");
exit;
}
...
<div id="modaladd" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="score_form" name="score_form" action="quarterdate.php" method="POST">
...
<div class="row row-screen">
	...
	<div class="row row-screen whiteboard" id="navigation">
		<div class="">
			<div class="pull-right date-time dropdown"><a  href="" class="  dropdown-toggle" id="menu1" data-toggle="dropdown">Quarter To Date  <i class="fa fa-caret-down" aria-hidden="true" ></i></a>
			...
			<ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
		     ...
		     <h3 style="margin-top:0px;"><small>Oct 1, 2017 - Dec 6, 2017</small></h3>
			</div>
		</div>
	</div>
	<br>
	...
	<div class="row row-screen">
		...
		<div class="table-inner1">
			<table class="table marB15">
				<thead>
					<tr>
						<th class="text-center">Quarter To Date</th>
				...
				<tbody>
					...
					<tr>
						...
						<div class="gross-year padT10"># of Cases Quoted</div><button class="btn ">1,458</button>
						
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">1,370<i class="fa fa-arrow-up" aria-hidden="true"></i><span>6%</span></button>
							</div>

						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">1,313 <i class="fa fa-arrow-up" aria-hidden="true"></i><span>11%</span></button>
						</div>
						</td>
					</tr>
					<tr>
						...
						<div class="gross-year padT10">AUM of Cases Quoted ($M)</div><button class="btn ">$807</button>
						
						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">$688<i class="fa fa-arrow-up" aria-hidden="true"></i><span>17%</span></button>
							</div>
						</td>
						<td class="">
							<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">$640<i class="fa fa-arrow-up" aria-hidden="true"></i><span>26%</span></button>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down btn-block retative">41%<i class="fa fa-arrow-up" aria-hidden="true"></i><span>4%</span></button>
							</div>
						</td>
						<td class="">
						<div class="btn-handle">
							<button class="btn btn-sales-down1 btn-block retative">40%<i class="fa fa-arrow-up" aria-hidden="true"></i><span>6%</span></button>
							</div>
						</td>
					</tr>
				</tbody>
		...
		<div class="table-inner">
			<table class="table marB15" border="1">
				...
				<tbody>
					...
					<tr>
					<td >	Willis / HRH	</td>
					<td class="text-center">	$3,02,76,367	</td>
					...
					<td class="text-center">	$2,66,43,203	</td>
					...
					<td class="text-center">	$2,42,21,094	</td>
					...
					<td class="text-center">	$2,30,10,039	</td>
					...
					<td class="text-center">	$2,11,93,457	</td>
					...
					<tr>
					<td >	Coresource	</td>
					<td class="text-center">	$1,93,76,875	</td>
					...
					<td class="text-center">	$1,81,65,820	</td>
					...
					<td class="text-center">	$1,77,62,135	</td>
		...
		<div class="table-inner">
			<table class=" table marB15" border="1">
				...
				<tbody>
					...
					<tr>
					<td >	CA	</td>
					<td class="text-center">	$6,05,52,734	</td>
					...
					<tr>
					<td >	PA	</td>
					<td class="text-center">	$5,32,86,406	</td>
					...
					<tr>
					<td >	TX	</td>
					<td class="text-center">	$4,84,42,188	</td>
					...
					<tr>
					<td >	AR	</td>
					<td class="text-center">	$4,60,20,078	</td>
					<td class="text-center">	6%	</td>
					...
					<tr>
					<td >	NY	</td>
					<td class="text-center">	$4,23,86,914	</td>
					...
					<tr>
					<td >	IN	</td>
					<td class="text-center">	$3,87,53,750	</td>
					<td class="text-center">	5%	</td>
					...
					<tr>
					<td >	MI	</td>
					<td class="text-center">	$3,55,24,271	</td>
...
<script type="text/javascript" src="js/quarterdate.js"></script>
